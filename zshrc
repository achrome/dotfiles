...
export PATH="/home/achrome/bin:/usr/lib/lightdm/lightdm:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/home/achrome/.rvm/bin"
export LANG=en_IN.UTF-8
[[ -s "/home/achrome/.gvm/bin/gvm-init.sh" ]] && source "/home/achrome/.gvm/bin/gvm-init.sh"
[[ -s "$HOME/.rvm/scripts/rvm" ]] && source "$HOME/.rvm/scripts/rvm" # Load RVM into a shell session *as a function*
export NVM_DIR="/home/achrome/.nvm"
